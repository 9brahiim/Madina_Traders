...
export default function ContactPageClient() {
  ...
  async function handleSubmit(e) {
    ...
    // Honeypot — see EnquiryModal.jsx for the matching hidden field.
    ...
    try {
      ...
      if (data.success) {
        // Redirect to a dedicated thank-you page rather than showing an
        // inline success message — gives Google Ads/Analytics a clean,
        // distinct URL to fire a conversion event on.
            ...
            <>
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                {/* Honeypot — hidden from sighted users and screen readers;
                    bots that auto-fill every input trip this, and
                    handleSubmit silently drops the submission. */}
                <div
                  aria-hidden="true"
                ...
                {status === STATES.ERROR && (
                  <p role="alert" className="text-[11px] text-red-400">
                    Something went wrong. Please call us directly or try
                    WhatsApp above.
                  </p>
                )}
                ...
                >
                  {status === STATES.LOADING ? "Sending..." : "Send Message →"}
                </button>
              </form>
            </>
          </div>
